    ...
    private function seedDemoData(): void
    {
        ...
        foreach ($classes as $classData) {
            ...
            foreach ($classData['sections'] as $sectionName) {
                $class->sections()->firstOrCreate(['name' => $sectionName]);
            }
            $schoolClasses->push($class->load('sections'));
        }
        ...
        foreach ($teachers as $i => $t) {
            $teacherModels->push(Teacher::firstOrCreate(
        ...
        foreach ($schoolClasses->take(3) as $class) {
            foreach ($class->sections as $section) {
                for ($i = 0; $i < 3; $i++) {
                    ...
                    $admissionNo = 'ADM-2026-'.str_pad($admissionCounter, 4, '0', STR_PAD_LEFT);
        ...
        $tuitionFee = FeeType::where('name', 'Monthly Tuition')->first();
        ...
        foreach ($students->take(10) as $student) {
            ...
            ExamResult::firstOrCreate(
                ...
                [
                    ...
                    'total_marks' => 100,
                    'grade' => ExamResult::calculateGrade($marks, 100),
